...
rm(list=ls())
# load libraries
library(kableExtra); library(ez); library(knitr); library(RColorBrewer); library(tidyverse)
...
tab.soc.E1 <- kable(d.soc.anova.E1, caption = "Social Feedback ANOVA (Valence x Monetary Reward") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
tab.soc.E1
...
d.liq.anova.E1 <-liquid.anova.E1$ANOVA %>%
  mutate(Effect = factor(Effect, levels = c("Valence","moneyreward","Valence:moneyreward"),
                         labels = c("Valence","Monetary Reward","Valence x Monetary Reward")))
tab.liq.E1 <- kable(d.liq.anova.E1, caption = "Liquid Feedback ANOVA (Valence x Monetary Reward") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
tab.liq.E1
```
...
###Figure 3-Post-block Affect Ratings across Social & Liquid Feedback
...
tab.affect <- kable(affect.anova.E1, caption = "Omnibus ANOVA (Incentive Type x Word Valence x Motivational Valence)") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
tab.affect
...
tab.soc.affect <- kable(affect.soc.anova.E1, caption = "Social Feedback ANOVA (Word Valence x Motivational Valence)") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
tab.soc.affect
...
affect.liq.anova.E1 <-liquid.affect.anova$ANOVA %>%
    mutate(Effect = factor(Effect, levels = c("Word_Valence","Valence","Word_Valence:Valence"),
                         labels = c("Affect Term Valence","Motivational Valence","Affect Term Valence x Motivational Valence")))
tab.liq.affect <- kable(affect.liq.anova.E1, caption = "Liquid Feedback ANOVA (Word Valence x Motivational Valence)") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
tab.liq.affect
```
...
###ANOVA Tables--Experiment II

``` {r ANOVAs_E2, message = F, warning = F}
#Omnibus ANOVA (Incentive Type x Valence x Monetary Reward)
omnibus.anova.E2<-ezANOVA(data = val.inc.mon.means, dv = meanRR, wid = .(Subject), within = c("Valence","IncentiveType","moneyreward"))
d.anova.E2 <- omnibus.anova.E2$ANOVA %>%
  mutate(Effect = factor(Effect, levels = c("Valence","IncentiveType","moneyreward","Valence:IncentiveType",
                         ...
                         labels = c("Valence","Incentive Type","Monetary Reward","Valence x Incentive Type","Valence x Monetary Reward",
                                    "Incentive Type x Monetary Reward", "Valence x Incentive Type x Monetary Reward"))) %>%
  rename("Generalized Eta Squared" = ges)
tab.omnibus.E2 <- kable(d.anova.E2, format = "html", digits = 3, caption = "Monetary Reward x Feedback Valence x Incentive Session -- Experiment I") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
tab.omnibus.E2
      
#Social Feedback ANOVA (Valence x Monetary Reward)
social.anova.E2<-ezANOVA((data = val.inc.mon.means %>% filter(IncentiveType== "Social")), dv = meanRR, wid = .(Subject), within = c("Valence","moneyreward"))
d.soc.anova.E2 <- social.anova.E2$ANOVA %>%
  mutate(Effect = factor(Effect, levels = c("Valence","moneyreward","Valence:moneyreward"),
                         labels = c("Valence","Monetary Reward","Valence x Monetary Reward")))
tab.soc.E2 <- kable(d.soc.anova.E2, caption = "Social Feedback ANOVA (Valence x Monetary Reward") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
tab.soc.E2

#Liquid Feedback ANOVA (Valence x Monetary Reward)
liquid.anova.E2<-ezANOVA((data = val.inc.mon.means %>% filter(IncentiveType== "Liquid")), dv = meanRR, wid = .(Subject), within = c("Valence","moneyreward"))
d.liq.anova.E2 <-liquid.anova.E2$ANOVA %>%
  mutate(Effect = factor(Effect, levels = c("Valence","moneyreward","Valence:moneyreward"),
                         labels = c("Valence","Monetary Reward","Valence x Monetary Reward")))
tab.liq.E2 <- kable(d.liq.anova.E2, caption = "Liquid Feedback ANOVA (Valence x Monetary Reward") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
tab.liq.E2
```
